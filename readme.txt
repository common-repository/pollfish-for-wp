...
Tags: pollfish,survey,surveys,monetization,wordpress
...
This Plugin is not owned or has any affiliation with Pollfish.

== Note ==

1. Please note that the plugin is using the Official Pollfish Javascript SDK file hosted on Google APIs. Google's Terms of use [https://developers.google.com/terms](https://developers.google.com/terms)
...
= What are all things I need to start using this plugin? =
...
1. Create/Login to Pollfish Publisher Account.
...
1. Find Pollfish for WP Settings under wp-admin > Settings page.
2. Pollfish Settings Page Part 1
3. Pollfish Settings Page Part 2
